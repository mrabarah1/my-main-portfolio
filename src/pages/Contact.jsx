...
const Contact = () => {
  ...
  return (
    <>
      ...
      <div className="grid place-content-center sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 mx-auto max-w-7xl px-8 py-20 gap-24">
        <motion.div
        ...
        <motion.div
          ...
          className="my-0 mx-auto w-full sm:max-w-md p-5 bg-[#00000085] shadow-md overflow-hidden sm:rounded-lg rounded mt-2 mb-10"
        >
          <form onSubmit={submitForm} className="mt-8">
            <h1 className="text-2xl capitalize text-white mx-auto px-32">
              contact form
            </h1>
            ...
            <Button className="mb-2 w-full py-5 px-40 text-center text-xs font-bold">
